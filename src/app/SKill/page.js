...
function Skill() {
  return (
    <div className="xl:px-[10%] lg:px-[7%] sm:px-[7%] pt-14 md:pb-20 xl:h-[100vh] sm:block lg:flex justify-between">
      <aside className="lg:w-[45%] sm:w-[70%] xl:mt-14 lg:mt-28">
        <Image src={immg1} className="w-full" />
      </aside>
      <aside className="lg:w-[45%] sm:w-[80%] lg:mt-0 sm:mt-10">
        <div className="flex">
          ...
          <p className="xl:text-xl lg:text-lg sm:mt-2 lg:mt-4 ml-3 font-bold">
            Premium learning experience
          </p>
        </div>
        <h1 className="xl:text-6xl lg:text-5xl sm:text-3xl font-bold sm:mt-10 lg:mt-20 xl:mt-10">
        ...
        <p className="mt-2 text-slate-400 sm:text-[0.75rem] lg:text-[0.8rem] xl:text-[0.9rem]">
