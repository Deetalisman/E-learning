...
function Article() {
  return (
    <div className="xl:px-[10%] px-[10%] pt-16 pb-20 bg-[rgb(229,231,235)]">
      <p className="xl:text-5xl lg:text-4xl text-3xl sm:text-3xl font-bold">
        Latest Article
      </p>
      <aside className="mt-10 lg:mt-20 flex flex-wrap justify-between">
        ...
        <div className="bg-white sm:w-[45%] lg:w-[30%] rounded-md sm:mt-0 mt-7 ">
        ...
        <div className="bg-white sm:w-[45%] lg:w-[30%] rounded-md lg:mt-0 mt-7 sm:mt-10">
